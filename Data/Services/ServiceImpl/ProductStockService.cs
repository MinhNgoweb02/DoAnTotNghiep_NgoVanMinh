...
namespace Data.Services.ServiceImpl
{
    public class ProductStockService : IProductStockService
    {
        ...
        public ProductSize GetProductSizeByProductIdAndSizeId(long productId)
        {
            return db.ProductSizes.Where(x => x.ProductId == productId ).FirstOrDefault();
        }

        public int GetStock(long productId)
        {
            return db.ProductSizes.Where(x => x.ProductId == productId ).FirstOrDefault().Stock;
        }
